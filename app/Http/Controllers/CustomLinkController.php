...
class CustomLinkController extends Controller
{
    ...
    */
    public function index(Request $request)
    {
        ...
        return view('custom-link.index', compact( 'items', 'block_id', 'name' ));
    }
    ...
    */
    public function create(Request $request)
    {
        ...
        return view('custom-link.create', compact('block_id', 'name'));
    }
    ...
    */
    public function edit($id)
    {
        ...
        return view('custom-link.edit', compact('detail', 'block_id', 'name'));
    }
