...
class TagController extends Controller
{
    ...
    */
    ...
    {     
        ...
        return view('tag.index', compact( 'items', 'type', 'name', 'district_id'));
    }
    ...
    */
    public function create(Request $request)
    {
        ...
        return view('tag.create', compact('type'));
    }
    ...
    */
    public function store(Request $request)
    {
        ...
        return redirect()->route('w-tag.index', [ 'type' => $dataArr['type'] ]);
    }
    ...
    */
    ...
    {        
        ...
        return view('tag.edit', compact( 'detail', 'meta'));
    }
    ...
    */
    public function destroy($id)
    {
        ...
        return redirect()->route('w-tag.index');
    }
}