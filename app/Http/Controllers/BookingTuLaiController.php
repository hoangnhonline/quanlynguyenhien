...
class BookingTuLaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $arrSearch['range_date'] = $range_date = $request->range_date ? $request->range_date : $currentDate->format('d/m/Y') . " - " . $currentDate->format('d/m/Y'); //th

        //$arrSearch['tour_type'] = $tour_type = $request->tour_type ?? [1,2,3];
        $query = Booking::where(['type' => 4, 'tour_cate' => 2]);
        if($city_id){
        ...
        $carCate = CarCate::all();
            ...
            //if(Auth::user()->id == 21){
            if($agent->isMobile()){
                $view = 'booking-tu-lai.m-index';
            }else{
                $view = 'booking-tu-lai.index';
            }
    ...
    public function create(Request $request)
    {
        ...
        return view("booking-tu-lai.add", compact('listUser', 'listTag', 'ctvList', 'nhaxeList', 'cateList', 'user_id_default'));
    }
    public function edit($id, Request $request)
    {
      ...
      $city_id = $detail->city_id;
        ...
        return view('booking-tu-lai.edit', compact( 'detail', 'listUser', 'arrSearch', 'listTag', 'ctvList', 'carCate', 'nhaxeList', 'city_id'));
    }
    public function store(Request $request)
    {
        ...
        $dataArr['type'] = 4;
        $dataArr['tour_cate'] = 2; // thue xe tu lai
      ...
      // dd($userIdPush);
        ...
        return redirect()->route('booking-tu-lai.index', ['use_date_from' => $use_date]);
    }
    public function update(Request $request)
    {
        ...
        return redirect()->route('booking-tu-lai.index', ['use_date_from' => $use_date, 'user_id' => $dataArr['user_id']]);
    }
