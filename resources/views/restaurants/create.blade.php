...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form role="form" method="POST" action="{{ route('restaurants.store') }}" id="dataForm" class="productForm">
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="home">
                                            ...
                                            <div class="row">                                               
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="input" id="latitude" class="form-control" name="latitude" value="{{ old('latitude') }}">
                                                </div>                                                                                          
                                                <div class="col-md-6 form-group">
                                                    <label>Longitude<span class="red-star">*</span></label>
                                                    <input type="text" class="form-control req" name="longitude" id="longitude" value="{{ old('longitude') }}">
                                                </div>
                                            </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="lienhe">
                                            ...
                                            <div class="form-group">
                                                <div class="checkbox">
                                                    <label for="co_chi">
                                                        <input type="checkbox" id="co_chi" name="co_chi" value="1" {{ old('co_chi') == 1 ? "checked" : "" }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="phan_tram_chi" id="phan_tram_chi">
                                                    <option value="">--Chọn--</option>
                                                    <option value="30" {{ old('phan_tram_chi') == 30 ? "selected" : "" }}>30%</option>
                                                    <option value="25" {{ old('phan_tram_chi') == 25 ? "selected" : "" }}>25%</option>
                                                    <option value="20" {{ old('phan_tram_chi') == 20 ? "selected" : "" }}>20%</option>
                                                    <option value="15" {{ old('phan_tram_chi') == 15 ? "selected" : "" }}>15%</option>
                                                    <option value="10" {{ old('phan_tram_chi') == 10 ? "selected" : "" }}>10%</option>
                                                    <option value="5" {{ old('phan_tram_chi') == 5 ? "selected" : "" }}>5%</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label>Quy định chi</label>
                                                <input type="text" class="form-control" name="quy_dinh_chi" id="quy_dinh_chi" value="{{ old('quy_dinh_chi') }}" placeholder="VD: Chỉ giảm tiền thức ăn, không giảm tiền nước...">
                                            </div>
                                        </div>
