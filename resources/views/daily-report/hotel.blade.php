    ...
    <div class="content-wrapper" style="min-height: 926px;">
        ...
        <section class="content-header">
            <h1 style="text-transform: uppercase;">
                Báo cáo đặt khách sạn
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                <li class="active">Báo cáo đặt khách sạn</li>
            </ol>
        </section>

        <div class="panel panel-default" style="margin: 30px 0">
            <div class="panel-body">
                <form class="form-inline" role="form" method="GET" action="{{ route('daily-report.hotel') }}" id="searchForm">
                    ...
                    <div class="chart-item-container line-chart-container">
                        <div class="chart-des">
                            ...
                            <div class="line-chart-legend">
                                ...
                                <div class="legend-item">
                                    <div class="legend-value">
                                        {{number_format(($totalRevenue) / 1000000)}} M
                                    </div>
                                    <div class="legend-label">
                                        Lợi Nhuận
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="chart-item-container pie-chart-2">
                                ...
                                <div class="chart-des">
                                    <h2>DT theo hạng sao</h2>
                                    @php
                                        $colors =  ['#5e3967', '#31356e', '#2f5f98', '#2d8bba', '#41b8d5', '#6ce5e8','#411b4a'];
                                        $index = 0;
                                    @endphp
                                    @foreach($byStarChartData as $key=>$value)
                                        @php
                                            $color = $colors[$index];
                                        @endphp
                                        <div class="label label-success" style="background-color: {{ $color }} !important;">{{ number_format($value) }}vnđ</div>
        ...
        $(document).ready(function (){
            ...
            new Chart(pieChart1El, {
                ...
                data:  {
                    ...
                    datasets: [
                        {
                            data: @json(array_map('intval',array_values($byLevelChartData))),
            ...
            new Chart(pieChart3El, {
                type: 'pie',
                data:  {
                    labels: @json(array_keys($byStarChartData)),
                    datasets: [
                        {
                            data: @json(array_map('intval',array_values($byStarChartData))),
                            backgroundColor: ['#5e3967', '#31356e', '#2f5f98', '#2d8bba', '#41b8d5', '#6ce5e8'],
                            borderColor: 'rgba(0,0,0,0)'
                        }
                    ],
