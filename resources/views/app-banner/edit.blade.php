            ...
            <div class="box-body">
              ...
              @endif             
               <div class="form-group">
                  ...
                  <input type="text" name="display_order" id="display_order" class="form-control" value="{{ old('display_order', $detailBanner->display_order) }}">
                </div>
                 <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  <label class="col-md-3 row">Banner <?php 
                  if($object_type == 1){
                    echo "( 500 x 280 px)";
                  }elseif($object_type == 7 || $object_type == 6){
                    echo "( 160 x 0 px)";
                  }else{
                    if($object_id == 1){
                      echo "( 1950 x 700 px)";
                  ...
                  <div class="col-md-9">
                    <img id="thumbnail_image" src="{{ $detailBanner->image_url ? Helper::showImage($detailBanner->image_url) : asset('admin/dist/img/img.png') }}" class="img-thumbnail" width="145" height="85">
                ...
                <div class="form-group" id="div_lk" style="display:none">
                  ...
                  <input type="text" name="link" id="link" value="{{ $detailBanner->link }}" class="form-control">
                </div>  
