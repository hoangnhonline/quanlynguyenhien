            ...
            <div class="box-body">
              ...
              <div class="form-group col-md-4">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <select class="form-control select2" name="type" id="type">
                      ...
                      <option value="{{ $item->id }}" {{ old('type', $detail->type) == $item->id ? "selected" : "" }}>{{ $item->name }}</option>
                      @endforeach
                    </select>
                  </div>
                  <div class="form-group col-md-4">
              ...
              <div class="form-group col-md-4 col-xs-4">
                    ...
                    <select class="form-control select2" name="tour_no">
                      <option value="">--Chọn--</option>
                      @for($i = 1; $i<=10; $i++)
                      <option value="{{ $i }}" {{ old('tour_no', $detail->tour_no) == $i ? "selected" : "" }}>Tour {{ $i }}</option>
                      @endfor
                    </select>
                </div>
                <div class="form-group col-md-4 col-xs-4">
              ...
              <div class="row" id="load_doi_tac">
                ...
                <div class="row">
                  ...
                  <div class="tinh-toan" >
                    <div class="form-group col-xs-6">
                      ...
                      <input type="text" name="amount" class="form-control amount" placeholder="Số lượng" value="{{ old('amount', $detail->amount) }}" autocomplete="off">
                    </div>
                    <div class="form-group col-xs-6">
                ...
                <div class="form-group ">
                    ...
                    <input type="text" name="noi_dung_ck" id="noi_dung_ck" class="form-control" placeholder="Nội dung CK (không dấu và ký tự đặc biệt)" value="{{ old('noi_dung_ck', $detail->noi_dung_ck) }}">
                  </div>
                  <div class="clearfix"></div>
