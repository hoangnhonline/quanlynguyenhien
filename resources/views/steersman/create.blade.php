    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('steersman.index') }}">Thêm mới tài công</a></li>
        ...
        <section class="content">
            <a class="btn btn-default btn-sm" href="{{ route('steersman.index') }}" style="margin-bottom:5px">Quay
                lại</a>
            <form role="form" method="POST" action="{{ route('steersman.store') }}" id="dataForm"
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" rows="4" name="bio" id="bio">{{ old('bio') }}</textarea>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12 box">
                                            <div class="box-body text-center">
                                                ...
                                                <div id="div-image2" style="margin-top:10px">
                                                    @if (!empty(old('degree_img')))
                                                        @foreach (old('degree_img') as $k => $image)
                                                            <div class="col-md-3">
