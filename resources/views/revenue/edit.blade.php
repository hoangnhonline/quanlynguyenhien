          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" name="not_kpi" value="1" {{ old('is_fixed', $detail->not_kpi) == 1 ? "checked" : "" }}>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="status" id="status">
                    ...
                    <option value="1"  {{ old('status', $detail->status) == 1 ? "selected" : "" }}>Đã thu</option>
                    <option value="2"  {{  old('status', $detail->status) == 2 ? "selected" : "" }}>Chưa thu</option>
                  </select>
                </div>
                <div class="form-group">
