            ...
            <div class="box-body">
             ...
             <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6">
                  ...
                  <div class="checkbox">
                    <label style="color: red; font-weight: bold;">
                      <input type="checkbox" name="acc_checked" value="1" {{ old('acc_checked', $detail->acc_checked) == 1 ? "checked" : "" }}>
                      Kế toán đã check
                    </label>
                  </div>
                </div>
                ...
                <div class="form-group col-md-12">
                  ...
                  <select class="form-control select2" name="nguoi_chi" id="nguoi_chi">
                    ...
                    <option value="{{ $col->id }}" {{ old('nguoi_chi', $detail->nguoi_chi) == $col->id ? "selected" : "" }}>{{ $col->name }}</option>
                    @endforeach
                  </select>
                </div>
              ...
              <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" name="content" value="{!! old('content', $detail->content) !!}" placeholder="Nội dung chuyển khoản">
              </div>
