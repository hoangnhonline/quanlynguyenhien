          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
             ...
             <?php 
                ...
                ?>
                <input type="hidden" name="city_id" value="{{ $costDetail->city_id }}">
                <input type="hidden" name="cost_id" value="{{ $costDetail->cost_id }}">
                <h4 class="col-md-12">CODE chi phí : <span class="hot">CP{{ $costDetail->id }}</span></h4>     
                <div class="form-group col-md-12 col-xs-12" style="font-size: 18px">
                  <label for="total_money" style="font-weight: normal;">Tổng tiền: </label>
                  <span class="hot">{{ number_format($costDetail->total_money) }}</span>
                  <input type="hidden" name="total_money" value="{{ $costDetail->total_money }}">
                </div>     
               ...
               <div class="form-group col-md-12 col-xs-12">
                <label for="email">Ngày thanh toán</label>
                <input type="text" name="date_pay" class="form-control datepicker" value="{{ old('date_pay', date('d/m/Y')) }}" autocomplete="off">
              </div>  
              ...
              <div class="form-group col-md-12">
                ...
                <textarea class="form-control" name="content" placeholder="Nội dung" rows="7">{!! old('content', 'Thanh toán code CP'.$costDetail->id) !!}</textarea>
              </div>   
