...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('booking-dn.update') }}" id="dataForm">
              ...
              <div class="row">
                ...
                <div class="form-group col-xs-6">
                  ...
                  <select class="form-control select2" id="tour_type" name="tour_type">
                      ...
                      <option value="2" {{ old('tour_type', $detail->tour_type) == 2 ? "selected" : "" }}>Tour riêng</option>
                  </select>
                </div>
               ...
               <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-xs-6">
                        <label>Giá gốc</label>
                      <input type="text" name="adult_cost" id="adult_cost" class="form-control cost number" value="{{ old('adult_cost', $detail->adult_cost) }}"  autocomplete="off">
                    </div>
                  </div>
                  <div class="row">
                  <div class="form-group col-xs-6" >
                      <label>Giá bán</label>
                      <input type="text" name="price_adult" id="price_adult" class="form-control number price" value="{{ old('price_adult', $detail->price_adult) }}"  autocomplete="off">
                  </div>
                  <div class="form-group col-xs-6" >
                      <label>Tổng tiền</label>
                      <input type="text" name="total_price_adult" id="total_price_adult" class="form-control number total" value="{{ old('total_price_adult', $detail->total_price_adult) }}" autocomplete="off">
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-xs-6">
                        <label>Giá gốc</label>
                      <input type="text" name="child_cost" id="child_cost" class="form-control number cost" value="{{ old('child_cost', $detail->child_cost) }}" autocomplete="off">
                    </div>
                  </div>
                  <div class="row">
                  <div class="form-group col-xs-6">
                      <label>Giá bán</label>
                      <input type="text" name="price_child" id="price_child" class="form-control number price" value="{{ old('price_child', $detail->price_child) }}" autocomplete="off">
                  </div>
                  <div class="form-group col-xs-6" >
                      <label>Tổng tiền</label>
                      <input type="text" name="total_price_child" id="total_price_child" class="form-control number total" value="{{ old('total_price_child', $detail->total_price_child) }}" autocomplete="off">
                  </div>
                </div>
