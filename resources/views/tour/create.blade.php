...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('tour.store') }}" id="dataForm" class="productForm">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="home">                         
                      <input type="hidden" name="type" value="1">                                                                                       
                        ...
                        <div class="form-group" style="margin: 20px 0 20px 0">
                          ...
                          <div class="col-md-3">
                            <label>
                              <input type="checkbox" {{ in_array($obj->id, old('objects_id', [])) ? "checked" : "" }} name="objects_id[]" value="{{ $obj->id }}">
                              {{ $obj->name }}
                            </label>
                          </div>
                          @endforeach
                        ...
                        <div class="form-group" style="margin-top:15px;">                  
                          ...
                          <select class="form-control" name="children_type" id="children_type">
                            <option value="1" {{ old('children_type') == 1 ? "selected" : "" }}>Theo độ tuổi</option>
                            <option value="2" {{ old('children_type') == 2 ? "selected" : "" }} >Theo chiều cao</option>
                          </select>
                        </div>
                        <div class="row">
                          <div class="col-md-4 form-group">
                            <label>Giá người lớn <span class="red-star">*</span></label>
                            <input type="text" class="form-control req number" maxlength="11" name="price_adult" id="price_adult" value="{{ old('price_adult') }}">
                          </div> 
                          <div class="col-md-4 form-group">
                            <label>Giá trẻ em <span class="red-star">*</span></label>
                            <input type="text" class="form-control req number" maxlength="11" name="price_child" id="price_child" value="{{ old('price_child') }}">
                          </div>  
                          <div class="col-md-4 form-group">
                            <label>Giá con nít<span class="red-star">*</span></label>
                            <input type="text" class="form-control req number" maxlength="11" name="price_infant" id="price_infant" value="{{ old('price_infant') }}">
                          </div>
                        </div>
