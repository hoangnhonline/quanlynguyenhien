...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('doi-tac.store-kpi') }}" id="formData">
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#month_change, #year_change').change(function(){
        location.href = "{{ route('doi-tac.kpi', ['id' => $detail->id]) }}?month=" + $('#month_change').val() + '&year=' + $('#year_change').val()
      });  
    });
