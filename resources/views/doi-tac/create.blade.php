...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('doi-tac.index') }}">Tài khoản</a></li>
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('doi-tac.index') }}" style="margin-bottom:5px">Quay lại</a>
    <form role="form" method="POST" action="{{ route('doi-tac.store-tx') }}" id="formData">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
                ...
                <input type="hidden" name="user_id_manage" value="0">
                <input type="hidden" name="debt_type" value="1">
              
                 <div class="form-group">
                  <label>Email</label>
                  <input type="text" class="form-control" name="email" autocomplete="off" id="email" value="{{ old('email') }}">
                </div>               
            ...
            <div class="box-footer">             
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('doi-tac.index')}}">Hủy</a>
            </div>
