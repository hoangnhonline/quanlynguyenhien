...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('booking-xe-may.update') }}" id="dataForm">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
                ...
                <div class="row">
                  ...
                  <div class="form-group col-xs-4" >
                      ...
                      <select class="form-control select2" name="nguoi_thu_coc" id="nguoi_thu_coc">
                        ...
                        <option value="3" {{ old('nguoi_thu_coc', $detail->nguoi_thu_coc) == 3 ? "selected" : "" }}>Nhà xe</option>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-xs-4">
                      ...
                      <select class="form-control select2" name="nguoi_thu_tien" id="nguoi_thu_tien">
                        ...
                        <option value="3" {{ old('nguoi_thu_tien', $detail->nguoi_thu_tien) == 3 ? "selected" : "" }}>Nhà xe</option>
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('booking-xe-may.index', ['type' => 4])}}">Hủy</a>
            </div>
        </div>
        <!-- /.box -->
      </div>
