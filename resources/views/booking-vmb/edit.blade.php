...
<div class="content-wrapper">
  ...
  <h1 style="text-transform: uppercase;">
      Đặt VMB : cập nhật <span style="color: red">PTB{{ $detail->id }}</span>
    </h1>
  </section>
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('booking-vmb.update') }}" id="dataForm">
            ...
            <div class="box-body">
              ...
              <div class="row">
                 <div class="form-group col-xs-12">
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="tour_cate" value="2" {{ old('tour_type', $detail->tour_cate) == 2 ? "checked" : "" }}>
              ...
              <div class="row mb10">
                ...
                <div class="row" >
                  ...
                  <select class="form-control select2 location" name="location_id" id="location_id">
                    ...
                    <option value="{{ $location->id }}" {{ old('location_id', $detail->location_id) == $location->id ? "selected" : "" }}>{{ $location->name }} - {{ $location->code }}</option>
                    @endforeach
                  </select>
                </div>
                ...
                <div class="row" >
                  ...
                  <select class="form-control select2 location" name="location_id_2" id="location_id_2">
                    <option value="">--Chọn--</option>
                    @foreach($airportList as $location)
                    <option value="{{ $location->id }}" {{ old('location_id_2', $detail->location_id_2) == $location->id ? "selected" : "" }}>{{ $location->name }} - {{ $location->code }}</option>
                    @endforeach
                  </select>
                </div>
                ...
                <div class="row rooms-row">
                  ...
                  <div class="form-group col-xs-3 col-md-3">
                      <label>Giá gốc</label>
                      <input type="text" name="adult_cost" id="adult_cost" class="form-control number" value="{{ old('adult_cost', $detail->adult_cost) }}" autocomplete="off">
                  </div>
                  <div class="form-group col-xs-3 col-md-3">
                      <label>Giá bán</label>
                      <input type="text" name="price_adult" id="price_adult" class="form-control number room_price" value="{{ old('price_adult', $detail->price_adult) }}" autocomplete="off">
                  </div>
                  <div class="form-group col-xs-3 col-md-3">
                      <label>Thành tiền</label>
                      <input type="text" name="total_price_adult" id="total_price_adult" class="form-control number room_price_total" value="{{ old('total_price_adult', $detail->total_price_adult) }}" autocomplete="off">
                  </div>
                </div>
                <div class="row rooms-row">
                  <div class="form-group col-xs-3">
                  ...
                  <div class="form-group col-xs-3 col-md-3">
                      <label>Giá gốc</label>
                      <input type="text" name="child_cost" id="child_cost" class="form-control number" value="{{ old('child_cost', $detail->child_cost) }}" autocomplete="off">
                  </div>
                  <div class="form-group col-xs-3 col-md-3">
                      <label>Giá bán</label>
                      <input type="text" name="price_child" id="price_child" class="form-control number room_price" value="{{ old('price_child', $detail->price_child) }}" autocomplete="off">
                  </div>
                  <div class="form-group col-xs-3 col-md-3" >
                      <label>Thành tiền</label>
                      <input type="text" name="total_price_child" id="total_price_child" class="form-control number room_price_total" value="{{ old('total_price_child', $detail->total_price_child) }}" autocomplete="off">
                  </div>
                </div>
                <div class="row rooms-row">
                  <div class="form-group col-xs-3">
                  ...
                  <div class="form-group col-xs-3 col-md-3">
                      <label>Giá gốc</label>
                      <input type="text" name="infant_cost" id="infant_cost" class="form-control number" value="{{ old('infant_cost', $detail->infant_cost) }}" autocomplete="off">
                  </div>
                  <div class="form-group col-xs-3 col-md-3">
                      <label>Giá bán</label>
                      <input type="text" name="price_infant" id="price_infant" class="form-control number room_price" value="{{ old('price_infant', $detail->price_infant) }}" autocomplete="off">
                  </div>
                  <div class="form-group col-xs-3 col-md-3">
                      <label>Thành tiền</label>
                      <input type="text" name="total_price_infant" id="total_price_infant" class="form-control number room_price_total" value="{{ old('total_price_infant', $detail->total_price_infant) }}" autocomplete="off">
                  </div>
                </div>
