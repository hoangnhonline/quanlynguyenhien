...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route( 'acc-logs.index' ) }}">Lịch sử chuyển tiền</a></li>
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form class="form-inline" role="form" method="GET" action="{{ route('acc-logs.index') }}" id="searchForm">
            ...
            <div class="form-group">            
              <select class="form-control select2 search-form-change" name="nguoi_yeu_cau" id="nguoi_yeu_cau">
                ...
                <option value="{{ $payer->id }}" {{ $nguoi_yeu_cau == $payer->id ? "selected" : "" }}>{{ $payer->name }}</option>
                @endforeach
              </select>
            </div> 
            <div class="form-group">            
              <select class="form-control select2 search-form-change" name="nguoi_thuc_hien" id="nguoi_thuc_hien">
                <option value="">--Người thực hiện--</option>
                @foreach($collecterList as $payer)
                <option value="{{ $payer->id }}" {{ $nguoi_thuc_hien == $payer->id ? "selected" : "" }}>{{ $payer->name }}</option>
                @endforeach
              </select>
            </div> 
            <div class="form-group">
