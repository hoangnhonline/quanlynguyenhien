...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <a class="btn btn-default btn-sm" href="{{ route('ads-campaign.index') }}" style="margin-bottom:5px">Quay lại</a>
            <form role="form" method="POST" action="{{ route('ads-campaign.store') }}" id="dataForm">
                <div class="row">
                    <!-- left column -->
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control datepicker" name="from_date" id="from_date" autocomplete="off" placeholder="Ngày bắt đầu"  value="{{ old('from_date') }}">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="type">Ngày kết thúc <span class="red-star">*</span></label>
                                        <input type="text" class="form-control datepicker" name="to_date" id="to_date" autocomplete="off" placeholder="Ngày kết thúc"  value="{{ old('to_date') }}">
                                    </div>
                                    <div class="form-group col-md-4">
