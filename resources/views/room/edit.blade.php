                      ...
                      <input type="hidden" name="type" value="1">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="so_phong" id="so_phong">
                              <option value="1" {{ old('so_phong', $detail->so_phong) == 1 ? "selected" : "" }}>1</option>
                              <option value="2" {{ old('so_phong', $detail->so_phong) == 2 ? "selected" : "" }}>2</option>
                              <option value="3" {{ old('so_phong', $detail->so_phong) == 3 ? "selected" : "" }}>3</option>
                              <option value="4" {{ old('so_phong', $detail->so_phong) == 4 ? "selected" : "" }}>4</option>
                              <option value="5" {{ old('so_phong', $detail->so_phong) == 5 ? "selected" : "" }}>5</option>
                              <option value="6" {{ old('so_phong', $detail->so_phong) == 6 ? "selected" : "" }}>6</option>
                            </select>
                          </div>
                         <!-- <div class="row">
