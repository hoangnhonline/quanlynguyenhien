...
<div class="content-wrapper">
  ...
  <h1 style="text-transform: uppercase;">
      ...
      - KH : <span class="hot">{{ $customerDetail['name'] }}</span> - {{ $customerDetail['phone'] }}
      @endif
    </h1>
  </section>
                ...
                <div class="form-group col-md-12" >
                  ...
                  <select class="form-control select2" id="partner_id" name="partner_id">
                    <option value="">--Chọn--</option>
                      ...
                      <option value="{{ $nhaxe->id }}" {{ old('partner_id') == $nhaxe->id  ? "selected" : "" }}>{{ $nhaxe->name }}</option>
                      @endforeach
                  </select>
                </div>
              ...
              <div class="row mb10">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-4 col-xs-12">
                    ...
                    <input type="text" class="form-control number" name="hoa_hong_cty" id="hoa_hong_cty" value="{{ old('hoa_hong_cty') }}">
                  </div>
