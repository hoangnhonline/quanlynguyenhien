            ...
            @if( $items->count() > 0 )
              ...
              <tr id="row-{{ $item->id }}">
                ...
                <td style="white-space:nowrap">
                  <a href="{{ route( 'w-banner.index', [ 'object_id' => $item->id, 'object_type' => 1 ]) }}" class="link_edit btn-sm btn-info btn"><span style="font-size: 16px;" class="badge">{{ $item->banners($item->id) }}</span> Banner</a> 
