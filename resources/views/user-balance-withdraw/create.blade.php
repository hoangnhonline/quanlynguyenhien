    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <a class="btn btn-default btn-sm" href="{{ route('user-balance-withdraw.index') }}" style="margin-bottom:5px">Quay
                lại</a>
            <form role="form" method="POST" action="{{ route('user-balance-withdraw.store') }}" id="dataForm">
                <div class="row">
                    <!-- left column -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-group-static my-3">
                                            ...
                                            <input type="text" class="form-control" name="account_name" id="account_name" value="{{old('account_name')}}" onfocus="focused(this)" onfocusout="defocused(this)">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-group-static my-3">
                                            <label class="ms-0">Số tài khoản</label>
                                            <input type="text" class="form-control" name="account_number" id="account_number" value="{{old('account_number')}}" onfocus="focused(this)" onfocusout="defocused(this)">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-group-static my-3">
                                            ...
                                            <select class="form-control select2" name="account_bank_name" id="account_bank_name">
                                                ...
                                                @foreach(\App\Helpers\Helper::getVietNamBanks() as $bank)
                                                    <option value="{{$bank['short_name']}}" {{old('account_bank_name') == $bank['short_name']? 'selected': ''}}>{{$bank['short_name']}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-group-static my-3">
                                            ...
                                            <input type="text" class="form-control" name="account_bank_branch" id="account_bank_branch" value="{{old('account_bank_branch')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 col-xs-6">
                                        ...
                                        <input type="text" name="amount" class="form-control number total"
                                               placeholder="Tổng tiền" value="{{ old('amount') }}">
                                    </div>
                                    <div class="form-group col-md-6 col-xs-6">
                                    ...
                                    <div class="form-group col-md-12" style="margin-top:10px;margin-bottom:10px">
                                        ...
                                        <div class="col-md-9">
                                            <img id="thumbnail_image"
                                                 src="{{ old('image_url') ? Helper::showImage(old('image_url')) : URL::asset('admin/dist/img/img.png') }}"
            ...
            <div class="modal-content">
                <form method="POST" action="{{ route('bank-info.ajax-save')}}" id="formAjaxBankInfo">
                    ...
                    <div class="modal-body" id="contentTag">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" class="form-control" id="add_name"
                                       value="{{ old('name') }}" name="name">
                            </div>
                            <div class="form-group">
                                <label>Tên ngân hàng<span class="red-star">*</span></label>
                                <select class="form-control select2" id="add_bank_name" name="bank_name"
                                        style="width: 100%">
                                    <option value="">--Chọn--</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" class="form-control" id="add_account_name"
                                       value="{{ old('account_name') }}" name="account_name">
                            </div>
                            <div class="form-group">
                                <label>Số tài khoản<span class="red-star">*</span></label>
                                <input type="text" autocomplete="off" class="form-control" id="add_bank_no"
                                       value="{{ old('bank_no') }}" name="bank_no">
                            </div>
                            <div class="form-group">
                                <label>Chi nhánh</label>
                                <input type="text" autocomplete="off" class="form-control" id="bank_branch"
                    ...
                    <div class="modal-footer" style="text-align:center">
                        ...
                        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal" id="btnCloseModalTag">
                            Close
                        </button>
                    </div>
                </form>
