...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('deposit.store') }}" id="dataForm">
    <div class="row">
      <!-- left column -->
            ...
            <div class="box-body">
              ...
              @endif  
                ...
                <div class="form-group col-xs-6">
                  ...
                  <div class="form-group col-xs-6">
                        ...
                        <select class="form-control select2" name="status" id="status">
                          ...
                          <option value="1" {{ old('status') == 1 ? "selected" : "" }}>Mới tạo</option>
                          <option value="2" {{ old('status') == 2 ? "selected" : "" }}>Đã CK</option>
                        </select>
                    </div>     
              </div>             
                 <!-- text input -->
                ...
                <div class="row">
                  ...
                  <div class="form-group col-xs-6">
                    <label>Ngày nộp<span class="red-star">*</span></label>
                    <input type="text" autocomplete="off"  class="form-control datepicker" name="deposit_date" id="deposit_date" value="{{ old('deposit_date') }}">
                  </div>
                ...
                <div class="row">
                  <div class="form-group col-xs-6">
                        ...
                        <select class="form-control select2" name="nguoi_nop_tien" id="nguoi_nop_tien">
                          ...
                          <option value="{{ $col->id }}" {{ old('nguoi_nop_tien') == $col->id ? "selected" : "" }}>{{ $col->name }}</option>
                          @endforeach
                        </select>
                    </div>
                  ...
                  <div class="form-group col-xs-6">
                        ...
                        <select class="form-control select2" name="nguoi_nhan_tien" id="nguoi_nhan_tien">
                          <option value="">--Chọn--</option>
                          @foreach($collecterList as $col)
                          <option value="{{ $col->id }}" {{ old('nguoi_nhan_tien') == $col->id ? "selected" : "" }}>{{ $col->name }}</option>
                          @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="sms" id="sms">{{ old('sms') }}</textarea>
                </div>
